...
//                 if(depth > 5){
//                     console.warn("getDependenceSkins 递归层数太高，请检查皮肤参数");
//                 }
//                 return;
//             }
...
//             // console.log('getSkinFunc:',skinName);
...
//             var adapter: eui.IThemeAdapter = stage ? egret.getImplementation("eui.IThemeAdapter") : null;
//             if(!adapter) {
