...
// 	 *
// 	 */
// 	export class MapAcceAction extends Animate {
...
//         private m_pMaxSpeed:number = 2000;
...
//         public lastPosition:egret.Point = egret.Point.create(0, 0);
//         private m_pActionPosition: egret.Point = egret.Point.create(0,0);
...
//             this.m_pActionTime += advancedTime;
